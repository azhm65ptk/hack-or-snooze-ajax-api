...
function generateStoryMarkup(story,showDeleteBtn=false) {
  ...
  //if a user is logged in , show favorite/not fav star
...
async function submitNewStory(evt){
  ...
  //get all info from the submit form,(author, title, url)
 ...
 */
 ...
 function putUserStoriesOnPage(){
   ...
   $ownStories.empty();// list of user's stories
 ...
 */
 ...
 /**Handle favorite or unfavorite a story
  */
...
function putFavoritesListOnPage(){
  ...
  if(currentUser.favorites.length===0){
    $favoritedStories.append("<h5>No favorite  added yet!</h5>");
  }
  else{          
